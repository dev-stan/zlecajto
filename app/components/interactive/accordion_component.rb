...
module Interactive
  class AccordionComponent < ApplicationComponent
    ...
    def item_header_classes
      ...
      'w-full flex items-center justify-between text-left text-gray-800 px-6 py-6 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 transition-colors'
    end
