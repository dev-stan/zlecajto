...
ActiveRecord::Schema[7.1].define(version: 2025_11_07_172824) do
  ...
  create_table "task_messages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["parent_id"], name: "index_task_messages_on_parent_id"
    t.index ["task_id", "parent_id"], name: "index_task_messages_on_task_id_and_parent_id"
  ...
  create_table "tasks", force: :cascade do |t|
    ...
    t.text "description"
    t.integer "salary"
    t.string "status", default: "Otwarte"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "category"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.datetime "last_seen_accepted_submission_at"
    t.string "phone_number", default: "", null: false
    t.string "superpowers", default: [], null: false, array: true
    t.string "provider"
    t.string "uid"
    t.boolean "admin"
    ...
    t.index ["last_seen_accepted_submission_at"], name: "index_users_on_last_seen_accepted_submission_at"
  ...
  add_foreign_key "task_messages", "users"
